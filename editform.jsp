<html>
	...
	<body>
		<%@page import="com.saddam.dao.UserDao,com.saddam.bean.User"%>
		...
		<input type="hidden" name="id" value="<%=u.getId() %>"/>
			<table>
				...
				<tr><td>Country</td><td><select name="country"><option>India</option><option>Pakistan</option><option>UK</option><option>USA</option><option>Other</option></select></td></tr>
				<tr colspan="2"><td><input type="submit" value="Edit User"/></td></tr>
			</table>
		</form>
